...
## Corpus Check
- 103 files · ~128,672 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 929 nodes · 1187 edges · 93 communities (67 shown, 22 thin omitted)
...
- `ReviewQueryPage()` --calls--> `getReviewPortalDataByToken()`  [EXTRACTED]
  src/app/review/page.tsx → src/lib/data/supabase-queries.ts
- `requestContentChangesAction()` --calls--> `createAdminClient()`  [EXTRACTED]
  src/lib/actions/content.ts → src/lib/supabase/admin.ts
- `BillingClient()` --calls--> `generateDraftInvoiceAction()`  [EXTRACTED]
  src/app/(workspace)/billing/billing-client.tsx → src/lib/actions/client.ts
...
Cohesion: 0.12
Nodes (19): dynamic, ReviewPortalPage(), CalendarClient(), CalendarPage(), dynamic, ClientWorkspacePage(), dynamic, ContentEditorPage() (+11 more)
...
Cohesion: 0.09
Nodes (30): LoginClient(), metadata, LogoutModal(), LogoutModalProps, CommandItem, CommandPalette(), BreadcrumbItem, HeaderContext (+22 more)

### Community 86 - "createAdminClient"
Cohesion: 0.19
Nodes (20): ClientWorkspaceView(), ClientWorkspaceViewProps, AddCredentialModal(), AddCredentialModalProps, LogExpenseModal(), LogExpenseModalProps, addTabooWordAction(), deleteClientAction() (+12 more)

### Community 87 - "react"
Cohesion: 0.14
Nodes (16): ADR-0001, react, react-dom, CalendarClientProps, CalendarEvent, CalendarView, dynamic, OperationsPage() (+8 more)

### Community 88 - "content.ts"
Cohesion: 0.22
Nodes (14): ContentStudioClient(), ContentStudioClientProps, ViewMode, ContentEditorClient(), ContentEditorClientProps, DEFAULT_PILLARS, NewContentModal(), NewContentModalProps (+6 more)

### Community 89 - "review-client.tsx"
Cohesion: 0.22
Nodes (11): dynamic, ReviewQueryPage(), FEEDBACK_CHIPS, ReviewPortalClient(), ReviewPortalClientProps, ReviewPostItem, AtomEchoLogo(), AtomEchoLogoProps (+3 more)

### Community 90 - "lucide-react"
Cohesion: 0.29
Nodes (8): lucide-react, CampaignsPage(), dynamic, ClientsDirectoryPage(), dynamic, OnboardClientModal(), createClientAction(), getClientsFromDb()

### Community 91 - "billing-client.tsx"
Cohesion: 0.36
Nodes (6): BillingClient(), BillingClientProps, BillingPage(), dynamic, markExpenseBilledAction(), getBillingDataFromDb()

### Community 92 - "command-center-client.tsx"
Cohesion: 0.36
Nodes (6): CommandCenterClient(), CommandCenterClientProps, CommandCenterPage(), dynamic, approveContentAction(), getCommandCenterDataFromDb()

## Knowledge Gaps
- **536 isolated node(s):** `nextConfig`, `name`, `version`, `private`, `dev` (+531 more)
...
- **Why does `react` connect `react` to `sidebar.tsx`, `createAdminClient`, `content.ts`, `review-client.tsx`, `lucide-react`, `billing-client.tsx`, `command-center-client.tsx`, `package.json`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `lucide-react` connect `lucide-react` to `supabase-queries.ts`, `sidebar.tsx`, `createAdminClient`, `react`, `content.ts`, `review-client.tsx`, `billing-client.tsx`, `command-center-client.tsx`, `package.json`?**
